...
#arch -x86_64 $TEST_RUNNER target/debug/writing-a-c-compiler --verbose --chapter 16 --stage lex --bitwise --compound --increment --goto --switch --nan
#rustfmt src/lexer/test.rs

#cp /dev/null src/parser/test.rs
#arch -x86_64 $TEST_RUNNER target/debug/writing-a-c-compiler --verbose --chapter 16 --stage parse --bitwise --compound --increment --goto --switch --nan
...
#arch -x86_64 $TEST_RUNNER target/debug/writing-a-c-compiler --verbose --chapter 15 --stage tacky --bitwise --compound --increment --goto --switch --nan
